  ...
  return (
    <>
      ...
      <p>
        ...
        of Owinoonline `&apos;`s Website, located at
        https://www.owinoonline.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Owinoonline.com if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Owinoonline.com, you agreed
        to use cookies in agreement with the Owinoonline `&apos;`s Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Owinoonline and/or its licensors own the
        intellectual property rights for all material on Owinoonline.com. All
        intellectual property rights are reserved. You may access this from
        Owinoonline.com for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        Owinoonline does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Owinoonline,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Owinoonline shall not be
      ...
      <p>
        Owinoonline reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Owinoonline a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Owinoonline; and (d) the link
      ...
      <p>
        ...
        e-mail to Owinoonline. Please include your name, your organization name,
      ...
      <p>
        No use of Owinoonline `&apos;`s logo or other artwork will be allowed
